...
import { StyleSheet, Text,View,SafeAreaView,Image, ScrollView , Dimensions,TouchableOpacity, BackHandler} from 'react-native';
...
const deviceWidth = Dimensions.get('window').width;
  ...
  const reportGBV = () => {
    setDoc(doc(db, "GBV", auth.currentUser.email), {
