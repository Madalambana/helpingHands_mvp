...
import { StyleSheet, Text,View, BackHandler,SafeAreaView,Image, TextInput, ScrollView , TouchableOpacity} from 'react-native';
...
const SAtxt = props  =>{
  ...
  return(
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.text2}> Gender Based Violence
      </Text>
